...
def init(args=[], ds=1):
    ...
    parser.add_argument("--nx", type=int, default=5*2**9//ds, help="number of pixels (vertical)")
    parser.add_argument("--ny", type=int, default=8*2**9//ds, help="number of pixels (horizontal)")
